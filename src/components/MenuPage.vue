    ...
    <div class="container">
          ...
          <div class="title-wrapper">
            <h1 class="sweet-title">
              <span data-text="Selamat Datang di">Selamat Datang di</span>
              <span data-text="WEKIDI">WEKIDI</span>
            </h1>
            <span class="top-title">Semua Asupan yang Anda Butuhkan Ada di</span>
            <span class="bottom-title">Pemadam Kelaparan</span>
          </div>
        </section>
    </div>
</template>
